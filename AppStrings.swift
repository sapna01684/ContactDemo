...
struct AppStrings {
    ...
    let normal_update_title = "Employee App"
    let normal_update_subtitle = "are you sure want to logout?"
    ...
    let alert_invalid_email_error = "Please enter valid email address"
    ...
    let notigicationAuthorized = "User granted permission for notification"
    
    let notigicationdenied = "User denied notification permission"
    
    let notigicationnotDetermined = "Notification permission haven't been asked yet"
    
    let notigicationprovisional = "The application is authorized to post non-interruptive user notifications."
    
    let notigicationephemeral = "The application is temporarily authorized to post notifications. Only available to app clips."
    
    let notigicationUnknow = "Unknow Status"

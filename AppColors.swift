...
struct AppColors {
    ...
    let textColor = UIColor(hex: "#504FA9")
    let theme_dark = UIColor(hex: "#567DF4")
    let theme_light = UIColor(hex: "F5F5F5")
    let themeborder = UIColor(hex:"EDECF2")
    let themeblack = UIColor(hexString: "#3F3F3F")
...
//    static var ColorAppGold                 : UIColor { return UIColor(named: "ThemeGoldColor")!}
    static var colorBGSkyBlueLight          : UIColor {return UIColor(hex: "567DF4")}
    static var colorTextBlack               : UIColor {return UIColor(hex: "3F3F3F")}
    static var colorTextPlaceHolderGray     : UIColor {return UIColor(hex: "ACACAC")}
    static var colorSkyBlue                 : UIColor {return UIColor(hex: "567DF4")}
    static var colorPurple                 : UIColor {return UIColor(hex: "504FA9")}
    static var colorsky                : UIColor {return UIColor(hex: "27AEE0")}
    
    static var colorBlack                : UIColor {return UIColor(hex: "2B2B2B")}
    static var colorDarkPurple                : UIColor {return UIColor(hex: "9988FC")}
    static var colorPink                : UIColor {return UIColor(hex: "FF95C5")}
    static var colorLightSky                : UIColor {return UIColor(hex: "78DCFE")}
    static var colorGreen                : UIColor {return UIColor(hex: "4AD591")}
    
    static var colorLightSkyBlue                : UIColor {return UIColor(hex: "F3F6FF")}
